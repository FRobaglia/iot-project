...
const CardDashboard = ({title, currentValue, dayMinValue, dayMaxValue, optimalMinValue, optimalMaxValue, sign, off}) =>  {

  const cardClass = off ? " card--off" : ""

  return (
    <article className={"card" + cardClass}>
        <CardHeader title={title} currentValue={!off ? currentValue : "--"} sign={sign}></CardHeader>
